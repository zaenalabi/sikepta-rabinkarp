		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="table-wrapper-scroll-y my-custom-scrollbar">
					<?php echo form_open("admin/kemiripan/cetakDok", array('id' => 'FormCetak')); ?>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="border border-primary p-3">
					...
					<div class="form-group row">
						<label class="col-sm-6 col-form-label">Tingkat kemiripan</label>
						<label class="col-sm-6 col-form-label" id="tingkatKemiripan">-</label>
					</div>
					<div class="form-group row">
	...
	$(document).ready(function () {
		...
		$('#btnStart').on('click', function () {
			...
			if ($("input[type='file']")[0].files.length === 0) {
				...
				$.ajax({
					url: "<?php echo site_url('admin/Kemiripan/getRabinKarp'); ?>",
					type: "POST",
					cache: false,
					data: form_data,
					contentType: false,
