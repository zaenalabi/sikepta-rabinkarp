    ...
    -->
            ...
            <li>
                ...
                <ul class="nav" id="my-sidebar-menu">
                    ...
                    <li>
                        <a class="nav-link" href="<?php echo base_url('member/Kemiripan'); ?>">
                            <i class="nc-icon nc-chart-bar-32"></i>
                            <p>Uji Kemiripan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('member/Dokumen'); ?>">
                            <i class="nc-icon nc-icon nc-paper-2"></i>
                            <p>Dokumen Uji</p>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="nav-link" href="<?php echo base_url('member/Petunjuk'); ?>">
                            <i class="nc-icon nc-settings-gear-64"></i>
                            <p>Petunjuk</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('member/Tentang'); ?>">
