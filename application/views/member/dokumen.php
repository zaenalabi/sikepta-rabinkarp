				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="border border-primary p-3">
							...
							<div class="form-group">
								<button id="btnStart" type="button" class="btn btn-primary">Simpan</button>
							</div>
							<?php echo form_close(); ?>
						</div>
					</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#btnStart').on('click', function () {
			...
			$.ajax({
				url: "<?php echo site_url('member/Kemiripan/tambah'); ?>",
				type: "POST",
				cache: false,
				data: form_data,
				contentType: false,
	...
	function loadData() {
		$.ajax({
			url: "<?php echo site_url('member/dokumen/getDokumen'); ?>",
			type: "GET",
			contentType: false,
			cache: false,
			dataType: "json",
